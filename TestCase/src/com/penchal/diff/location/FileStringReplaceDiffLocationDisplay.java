package com.penchal.diff.location;
...
public class FileStringReplaceDiffLocationDisplay {
	public static void main(String args[]) {
		try {
			...
			System.out.println("Create your own file to save the replaced content on local machine--> :");//comment start
			System.out.println("----------------------------------------------------------------------- ");
			...
			//location display
			System.out.println("The above content of the file location is : ==>");
			System.out.println("-------------------------------------------------");
			System.out.println(newFileGenerate);
